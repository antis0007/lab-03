...
public class MainActivity extends AppCompatActivity implements AddCityFragment.AddCityDialogListener, EditCityFragment.EditCityDialogListener{
    ...
    @Override
    public void editCity(City selected_city, String cityName, String provinceName) {
        //cityAdapter.add(selected_city);
        selected_city.setName(cityName);
        selected_city.setProvince(provinceName);
        cityAdapter.notifyDataSetChanged();
    }
